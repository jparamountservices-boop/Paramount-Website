...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${W} ${H}" width="${W}" height="${H}" font-family="Archivo, 'Arial Narrow', Arial, sans-serif">
  ...
  <!-- Subhead -->
  <text x="158" y="1130" fill="${CONCRETE}" font-size="66" font-weight="700">Like what you see? Your</text>
  <text x="158" y="1210" fill="${CONCRETE}" font-size="66" font-weight="700">neighbors get a deal.</text>

  <!-- Offer strip -->
  <g transform="translate(150 1300)">
    <rect x="0" y="0" width="1000" height="150" rx="14" fill="${INK}"/>
    <text x="50" y="98" fill="${WHITE}" font-size="86" font-weight="900" letter-spacing="-2">$500 OFF</text>
    <text x="560" y="66" fill="${FLAME}" font-size="46" font-weight="800">+ FREE</text>
    <text x="560" y="120" fill="${FLAME}" font-size="46" font-weight="800">DESIGN VISIT</text>
  </g>
  ...
  <text x="150" y="1738" fill="${FLAME_D}" font-size="38" font-weight="800" letter-spacing="3">CONCRETE · PAVERS · HARDSCAPES</text>
  ...
  <g transform="translate(1360 150)">
    ...
    <!-- Offer callout -->
    <text x="440" y="1010" text-anchor="middle" fill="${WHITE}" font-size="52" font-weight="900" letter-spacing="4">NEIGHBOR DISCOUNT</text>

    <g transform="translate(120 1060)">
      <rect x="0" y="0" width="640" height="150" rx="18" fill="${WHITE}"/>
      <text x="320" y="70" text-anchor="middle" fill="${INK}" font-size="66" font-weight="900">$500 OFF</text>
      <text x="320" y="122" text-anchor="middle" fill="${FLAME_D}" font-size="40" font-weight="800">+ FREE ON-SITE DESIGN</text>
    </g>

    <text x="440" y="1300" text-anchor="middle" fill="${WHITE}" font-size="40" font-weight="700" opacity="0.95">Recent projects + your offer,</text>
    <text x="440" y="1352" text-anchor="middle" fill="${WHITE}" font-size="40" font-weight="700" opacity="0.95">one quick scan away.</text>

    <g transform="translate(300 1400)">
      <rect x="0" y="0" width="280" height="64" rx="32" fill="${INK}"/>
      <text x="140" y="43" text-anchor="middle" fill="${WHITE}" font-size="34" font-weight="800" letter-spacing="4" font-family="monospace">NEIGHBOR500</text>
    </g>
  </g>
</svg>`;
